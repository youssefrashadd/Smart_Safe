...
void keypad_videnpullup(void)
{
	/*	ROW channel direction -> output	*/
// 	dio_vidEnablePullUp(KEYPAD_ROW1_PORT,KEYPAD_ROW1_CHANNEL);
// 	dio_vidEnablePullUp(KEYPAD_ROW2_PORT,KEYPAD_ROW2_CHANNEL);
// 	dio_vidEnablePullUp(KEYPAD_ROW3_PORT,KEYPAD_ROW3_CHANNEL);
// 	dio_vidEnablePullUp(KEYPAD_ROW4_PORT,KEYPAD_ROW4_CHANNEL);
	
	/*	COLUMN channel direction -> input	*/
	dio_vidEnablePullUp(KEYPAD_COL1_PORT,KEYPAD_COL1_CHANNEL);
	dio_vidEnablePullUp(KEYPAD_COL2_PORT,KEYPAD_COL2_CHANNEL);
	dio_vidEnablePullUp(KEYPAD_COL3_PORT,KEYPAD_COL3_CHANNEL);
	dio_vidEnablePullUp(KEYPAD_COL4_PORT,KEYPAD_COL4_CHANNEL);
